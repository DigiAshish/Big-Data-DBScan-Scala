package com.ashish.spark.dbscan

import com.ashish.spark.dbscan.spatial._
import org.apache.commons.math3.ml.distance.DistanceMeasure
import scala.collection.mutable.{ListBuffer, HashSet}
import org.apache.spark.rdd.RDD
import com.ashish.spark.dbscan.spatial.rdd.{PointsInAdjacentBoxesRDD, PointsPartitionedByBoxesRDD, PartitioningSettings}
import scala.Some
import com.ashish.spark.dbscan.util.commandLine.CommonArgs
import com.ashish.spark.dbscan.util.debug.DebugHelper
...
/** Implementation of the DBSCAN algorithm which is capable of parallel processing of the input data.
  ...
  *
  * @param settings Parameters of the algorithm. See [[com.ashish.spark.dbscan.DbscanSettings]]
  *                 for details
  * @param partitioningSettings Partitioning settings. See [[com.ashish.spark.dbscan.spatial.rdd.PartitioningSettings]]
  *                             for details
  */
class DistributedDbscan (
   ...
   *
   * @param data A data set to be clustered. See [[com.ashish.spark.dbscan.RawDataSet]] for details
   * @return A [[com.ashish.spark.dbscan.DbscanModel]] object which represents clustering results
   */
  ...
  /** Finds clusters within one partition
    ...
    *           when this method is called, [[com.ashish.spark.dbscan.spatial.Point]] objects in the collection
    *           already contain all necessary metadata, including number of their neighbors
    *
    * @param boundingBox A [[com.ashish.spark.dbscan.spatial.Box]] object which represents bounds of the whole dataset
