...
import com.ashish.spark.dbscan.spatial.{Point, DistanceAnalyzer}
import com.ashish.spark.dbscan.spatial.rdd.PointsPartitionedByBoxesRDD

/** Represents results calculated by DBSCAN algorithm.
  *
  * This object is returned from [[com.ashish.spark.dbscan.Dbscan.run]] method.
...
val settings: DbscanSettings)
  ...
  /** Predicts which cluster a point would belong to
    *
    * @param newPoint A [[com.ashish.spark.dbscan.PointCoordinates]] for which you want to make a prediction
    ...
    *         [[com.ashish.spark.dbscan.DbscanModel.NoisePoint]] is returned.
    *         If the point is surrounded by so many noise points that they can constitute a new
    *         cluster, then [[com.ashish.spark.dbscan.DbscanModel.NewCluster]] is returned
    */
...
object DbscanModel {
  ...
  /** Indicates that a new cluster would appear in a [[com.ashish.spark.dbscan.DbscanModel]] if
