...
import com.ashish.spark.dbscan.spatial.{PointSortKey, Point, Box}
import com.ashish.spark.dbscan.BoxId

/** A partitioner which assigns each entry in a dataset to a [[com.ashish.spark.dbscan.spatial.Box]]
  *
  * @param boxes A collection of [[com.ashish.spark.dbscan.spatial.Box]]es
  */
