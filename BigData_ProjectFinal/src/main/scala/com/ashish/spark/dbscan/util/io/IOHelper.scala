package com.ashish.spark.dbscan.util.io

import org.apache.spark.SparkContext
import scala.collection.mutable.WrappedArray.ofDouble
import com.ashish.spark.dbscan.{DbscanModel, RawDataSet, ClusterId, PointCoordinates}
...
object IOHelper {
  ...
  /** Reads a dataset from a CSV file. That file should contain double values separated by commas
    ...
    * @return A [[com.ashish.spark.dbscan.RawDataSet]] populated with points
    */
  ...
  /** Saves clustering result into a CSV file. The resulting file will contain the same data as the input file,
    ...
    * input file
    *
    * @param model A [[com.ashish.spark.dbscan.DbscanModel]] obtained from Dbscan.train method
