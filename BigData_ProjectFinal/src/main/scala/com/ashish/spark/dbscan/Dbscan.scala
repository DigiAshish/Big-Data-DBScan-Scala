...
import com.ashish.spark.dbscan.spatial.DistanceAnalyzer
...
object Dbscan {
  ...
  /** Instantiates an object which implements the DBSCAN algorithm
    ...
    *                 [[com.ashish.spark.dbscan.DbscanSettings]] for details
  ...
  /** A convenience method which you can use to start clustering
    *
    * @param data A [[com.ashish.spark.dbscan.RawDataSet]] which should be clustered
    * @param settings Parameters of the algorithm. See
    *                 [[com.ashish.spark.dbscan.DbscanSettings]] for details
    * @return A [[com.ashish.spark.dbscan.DbscanModel]] populated with information about clusters
    */
