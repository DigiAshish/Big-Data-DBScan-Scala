...
import com.ashish.spark.dbscan.{PairOfAdjacentBoxIds, BoxId, DbscanSettings, RawDataSet}
import com.ashish.spark.dbscan.spatial.rdd.{BoxPartitioner, PartitioningSettings}
import org.apache.spark.rdd.RDD
import org.apache.spark.SparkContext._

/** Calculates box-shaped regions for density-based partitioning (see [[com.ashish.spark.dbscan.spatial.rdd.BoxPartitioner]] )
  * and for fast lookup of point's neighbors (see [[com.ashish.spark.dbscan.spatial.PartitionIndex]]
  *
